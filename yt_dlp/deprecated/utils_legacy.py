...
# Re-export utils.networking symbols lazily
passthrough_module(__name__, '..utils.networking', (
    'escape_rfc3986', 'escape_url', 'random_user_agent', 'std_headers'
))

# Re-export networking._urllib symbols lazily
passthrough_module(__name__, '..networking._urllib', (
    'PUTRequest', 'HEADRequest', 'PerRequestProxyHandler', 
    'YoutubeDLRedirectHandler', 'make_socks_conn_class', 'update_Request'
))

# Re-export networking.exceptions lazily
passthrough_module(__name__, '..networking.exceptions', (
    'HTTPError', 'network_exceptions'
))
