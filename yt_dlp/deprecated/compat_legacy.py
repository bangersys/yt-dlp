...
# Inline compat_HTMLParseError to avoid circular import with compat/__init__.py
class compat_HTMLParseError(ValueError):
    pass


# Inline compat_expanduser to avoid circular import with compat/__init__.py
if os.name in ('nt', 'ce'):
...
def __getattr__(name):
    if name in ('compat_HTTPError', 'compat_urllib_HTTPError'):
